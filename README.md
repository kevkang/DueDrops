...
## Development environment and release process
 ...
 - create virtualenv with Flask and DueDrops installed into it (latter is installed in
...
install it (`pip install duedrops.tar.gz`), ensure that configuration file exists and
`DUEDROPS_SETTINGS` environment variable points to it, ensure that user has access to the
